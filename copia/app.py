...
if st.session_state.user_auth is None:
    ...
    with st.form("login_form"):
        ...
        if submit:
            ...
            if res and res.user:
                st.session_state.user_auth = res.user
...
# Extraemos los datos del perfil guardado
user_data = st.session_state.user_perfil

# Ajuste de nombres de variables para que coincidan con los Bloques 1, 2, 3 y 4
es_admin = user_data.get('rol') == 'admin'
mi_sede_id = user_data.get('sede_id')
# Verificamos si existe el nombre de la sede por el join de Supabase
